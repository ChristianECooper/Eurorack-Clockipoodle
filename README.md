...
3. Four additional outputs that can be a multuplied, divided, duplicate or a disabled copy of the main clock.
4. Tap to set BPM.
5. Variable pulse width.
6. Play/Pause.
7. Reset the various outputs to be in sync again.

There is also an unused input currenly labeled as 'Clock in' and and associated LED, which may become a Clock in or CV input that drives a parameter (or parameters) to be later defined.
...
In the meantime I'm considering using the CV to drive swing.
